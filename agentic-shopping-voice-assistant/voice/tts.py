...
class ElevenLabsTTS:
    ...
    # Default ElevenLabs voices (Updated from API 2024-12-04)
    DEFAULT_VOICES = {
        # Female voices
        ...
        # Male voices
        "adam": "pNInz6obpgDQGcFmaJgB",       # Male, American, middle-aged
        ...
        "callum": "N2lVS1w4EtoT3dr4eOWO",     # Male, American, middle-aged
    ...
    def __init__(
        ...
        self.default_voice_id = default_voice_id or self.DEFAULT_VOICES["sarah"]
...
VOICE_MAPPING = {
    # OpenAI voices -> ElevenLabs equivalents (updated)
    "alloy": "sarah",     # Neutral, balanced → young American female
    "echo": "adam",       # Male, clear → American male
    "fable": "jessica",   # Female, expressive → young American female
    "onyx": "george",     # Deep male → British middle-aged male
    "nova": "laura",      # Female, energetic → young American female
    "shimmer": "matilda", # Female, warm → American middle-aged female
    
    # Legacy mapping (for backward compatibility)
    "rachel": "sarah",    # Old default → new default
    "bella": "jessica",   # Old female → new female
    "antoni": "callum",   # Old male → new male
    "elli": "laura",      # Old female → new female
    "josh": "liam",       # Old male → new male
    "arnold": "george",   # Old male → new male
    "domi": "alice",      # Old female → new female
    "sam": "brian",       # Old male → new male
}
